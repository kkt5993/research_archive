...
> 본문 Q1–Q4(정책·변압기 공장·GOES·GIS/HVDC)는 유지. 아래는 **부하 큐 vs 발전 큐**, ERCOT 실숫자, BTM이 변압기를 건너뛰지 않는다는 점.

**클레임.** ERCOT 큐 438GW는 ‘요청’이다. 지금은 Abbott 감사로 그리드 대형부하가 멈춰 있고, 속도 테제는 BTM/WLPUN이다. BTM은 변압기·가스 측관을 건너뛰지 않는다.

**왜.**
- ERCOT 자체 마지막 공시: 대형부하(>75MW) 요청 **>438,000MW**(2026-06-18), DC **약 89%**. 피크 85,508MW(2023-08-10)와 비교하지 말 것.
- Batch Zero 예비 적격 **약 205GW**(데이터 2026-07-28, ERCOT 하원 2026-08-19). Abbott 2026-08-03 감사 → 분류 미발행(M-A080326-01).
- **474GW는 주지사 서한. ERCOT PDF 없음 → 쓰지 말 것.** 6.6GW/17건 “거의 가압”은 Seely 발언 Utility Dive **2차**.
- LBNL *Queued Up* 2026은 **발전** 큐다. ERCOT 발전 IR→IA 평균 24개월. 부하 대기는 별개. 2026-09-01 기준 그리드 대형 DC는 “빠르지” 않다.
- DOE: 대형 변전/GSU **3–4년**. 배전은 Prolec이 “최근 정규화”(같은 웨비나, LPT는 해당 없음). 부싱 최대 130주, OLTC 80–90주(NLR 2026.05).
- 실체: Crusoe/Google Goodnight **525.5MW** 단일 POI 뒤(PUCT 58881/59220, 2026-07-24). Calpine–CyrusOne Thad Hill 190MW, COD 2026 Q4, $1.2bn — 파워드랜드+그리드. Vistra–Amazon Comanche Peak 1,200MW 20년 PPA, 인도 2027 Q4–2032 — PPA+인접이지 고전적 BTM이 아님.

**반론.** 감사 리포트 타깃 2026-12-10(**2차**) 이후 Batch Zero가 열리면 그리드 접속이 다시 메인. Crusoe Abilene 약 600MW 증설 취소(DCD **2차**)는 BTM도 연료·허가·자본이 게이트라는 뜻.

**2–3Q 반증.** (1) ERCOT가 438GW를 크게 줄인 공식 큐를 낸다. (2) 12월 감사 후 분류가 실제로 나간다. (3) PUCT가 Goodnight형 30분 무보상 차단을 신규 가스 BTM까지 확장한다.

**투자 번역.** BTM = 항공파생/레시프 GT + GSU/서비스 TR + 가스 측관 + 차단기. 송전 MW만 줄 뿐 BOM은 안 줄어든다. 한국 LPT 수출 수요는 그리드 큐가 멈춰도 유지. 종목은 v2.
