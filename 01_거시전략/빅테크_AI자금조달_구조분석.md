...
## 🔴 사후 검증 (2026-08-11) — 질문은 옳았고, 답이 나온 방향이 달랐다

> **본문의 핵심 질문은 "빅테크가 데이터센터 Capex를 자체 자금으로 감당 가능한가, 아니면 회사채·장기금리에 종속되는가"였다. 두 달 뒤 시장이 답을 냈는데, 예상과 다른 쪽에서 나왔다.**
...
**코스피 사상 최대 월간 낙폭이다 — 1997년 외환위기와 글로벌 금융위기 때의 월간 낙폭을 넘어섰다.** 7월 7일에는 서킷브레이커가 발동했다.

**단, 경로가 극단적이었다는 점을 함께 봐야 한다.**
...
| **8/7** | **미국 7월 고용 −23,000명**(예상 +8만, 사실상 첫 감소) → **9월 인하 기대 부활.** 금리·달러 하락, 금 약 +7%, S&P500 +3.58%·나스닥 +5.19%(주간) |
| 8/10 | 코스피 6,306.33(+0.76%), 코스닥 807.66(+1.11%) |

*주간 수치 출처: 같은 저장소 `90_정기발간/2026-W32·W33 주간시장브리핑`(2출처 이상 교차검증)*

**방아쇠(검증됨)**: ① **메타 네오클라우드 발표** — 남는 AI 연산 자원을 외부 판매하겠다는 발표가 "AI 연산이 남아돈다 → 메모리 수요 종료 → 반도체 사이클 끝"으로 해석 ② **CXMT(창신메모리) 상장**으로 중국 메모리 추격 부각 ③ **미 국채금리 급등** ④ 상반기 누적 레버리지 청산.

**핵심 역설**: 같은 분기 실적은 **사상 최대**였다 — 삼성전자 2Q 영업이익 **89.5조원**(전년 대비 +1,813.8%, DS가 99.7%), SK하이닉스 **60.5조원**(OPM 76%). **이익이 아니라 "이익의 지속성"에 매겨진 멀티플이 무너졌다.**

**금리 환경**: 연준은 **케빈 워시 신임 의장 체제**, 기준금리 **3.50–3.75%**. 주요 IB 10곳 중 **7곳이 연내 동결 전망**으로 인하 전망을 철회했다. **단 8/7 고용쇼크(−23,000명)로 9월 인하 기대가 되살아났다**. **단 8/7 미국 7월 고용 −23,000명 쇼크로 9월 인하 기대가 되살아났다**(7/29 FOMC는 동결).

### 판정

**⏸ 자금 조달 제약은 아직 터지지 않았다.** 회사채 의존도·이자 부담이 임계점을 넘어 Capex를 강제로 꺾은 사건은 없었다. 다만 **미 국채금리 급등**이 7월 하락 요인으로 지목된 만큼, 이 보고서가 짚은 **"장기금리 종속" 축은 간접적으로 작동**했다.

**❌ 실제로 먼저 온 것은 "투자 의지" 문제였다.** **메타의 네오클라우드 발표**는 자금이 부족해서가 아니라, **남는 연산 자원을 수익화하겠다**는 것이었다. 시장은 이를 "AI 연산 공급 과잉 → 향후 Capex 둔화"로 읽었다.

🧒 **이 보고서의 프레임은 "돈이 모자라면 못 한다"였는데, 실제로는 "돈은 있는데 더 지을 이유가 줄었다"가 먼저 왔어요.** Capex 사이클을 끝내는 건 자금난만이 아니에요 — **수요 포화**가 먼저 올 수 있어요.

### 유효성

| 부분 | 상태 |
|---|---|
| OCF·Capex·회사채 구분 원칙과 실측 정리 | ✅ **유효.** 방법론적으로 견고 |
| "장기금리 종속" 구조 분석 | ✅ 유효. 금리 급등으로 오히려 중요도 상승 |
| Q1 2026 기준 수치 | ⚠️ 이후 분기 실적으로 갱신 필요 |
| "자금 조달이 병목" 결론 | ⚠️ **미검증.** 수요 축을 함께 봐야 함 |
...
#### 연간 추정 (2026)
- 연 매출: 약 $440B
- 연 영업이익: 약 $120B (1회성 제외)
- 연 OCF: **약 $150B**
- 연 Capex 가이던스: **약 $185B** (Capex/매출 46%)
- **자금 갭: -$35B**
...
- 연 영업이익: 약 $90B
- 연 OCF: **약 $110B**
- 연 Capex 가이던스: **약 $135B** (Capex/매출 54%) ⭐ 가장 공격적
- **자금 갭: -$25B**
...
| 항목 | 합산 | 비고 |
|---|---|---|
| 합산 매출 | **약 $1,785B** | 한국 GDP보다 큼 |
| 합산 영업이익 | **약 $480B** | 약 670조원 |
| 합산 OCF | **약 $585B** | 한국 GDP의 33% |
| 합산 Capex | **약 $635–700B** | Introl: $690B / Wolf Street: $700B |
