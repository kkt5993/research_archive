...
> 공개 1차(IR·ERCOT·DOE·DART·NRC). 기사가 실적/콜을 받아쓴 것은 **2차**. 위성 착공·SemiAnalysis 원문 재조합·트윗·랩 P&L·HBM은 이 데스크 범위 밖.
> 본문(7/30)의 생산–유통–사용 골격은 유지. 아래는 **26–27년에 실제로 사는 것**과 스택 전압만 갱신.

**한 줄.** 26–27 COD에 들어가는 것은 이미 슬롯이 잡힌 HA/LPT와 항공파생·레시프·UPS다. 오늘 신규 HA·345kV LPT 발주는 26–27 준공이 아니다.

**스택 (지금 짓는 홀은 거의 AC. 800VDC는 2027 파일럿.)**

| 층 | 전압·역할 | 26–27에 실제로 사는 것 |
|---|---|---|
| 그리드 접속 | POI 115/138/230/345kV. 발전 큐 ≠ 부하 큐 | 스터디·CIAC. FERC는 >50MW 부하 쇼코즈(2026.06). ERCOT는 텍사스 단독(SB6) |
| 변전 / LPT / GSU | 345·138 → 34.5/13.8kV | **긴 폴.** DOE Jereza(2026-03-05): 대형 3–4년. 히타치 사우스보스턴 착공 2026-06-29, 완공 타깃 2029(ENR **2차**) |
| MV 배전 | 13.8/34.5kV 스위치기어, MV–LV TR | 스위치기어 평균 44주(WoodMac Q2 2025). ABB·Siemens·Schneider·Eaton·LS |
| 온사이트 발전 | HA 프레임 vs 항공파생·레시프. 디젤은 스탠바이 | 신규 HA는 2029–31. 항공파생/레시프가 27–28 브릿지. SMR 전자는 26–27에 0 |
| BESS / UPS | 2시간급은 접속·램프 브릿지. 랙 UPS는 별개 | Vertiv 2Q26 매출 $3.274bn(+24%), FY25말 백로그 $15.0bn. 4h BESS 2026 mid $308/kWh는 **유틸리티 4시간**(NREL), UPS가 아님 |
| LV·PDU | 480/415V 버스웨이 → 랙 PDU | Uptime 2026 모달 랙 **>11kW**(전년 9kW). GB300 NVL72 랙당 최대 **142kW**(NVIDIA). Kyber 800VDC는 **2027** |

**$/단위 (섞지 말 것).** LPT $15–21k/MVA(USITC→NLR 2026.05). 신형 CCGT 최근 IRP 접수 **≥$2,000/kW**, 26–27 COD 분은 $1,116–1,427(GridLab 2025.09, 이미 사둔 기자재). SMR 모델 $8,936/kW(EIA/S&L 2023$)는 인보이스가 아님. MW급 UPS·스탠바이 디젤 공개 $/kW는 없음.

교차: 유통 숫자는 `2편`, 터빈·SMR·BTM은 `3편`, 한국 종목은 `10_국내주식/06_기계/전력기기_산업분석리포트_v2.md`.

**수요 CAGR.** 5.7% = Grid Strategies IRP/FERC 714 합산이지 EIA 공식이 아님. EIA AEO2026은 2050까지 0.9–1.6%, IEA Electricity 2026은 미국 ~2%/년. 55%는 GS 피크 기여; IEA는 증가분의 약 절반. GS 스스로 DC ~25GW 과대. 7%는 LBNL/DOE 2028 하단 6.7%(범위 6.7–12%). 5.7%를 미국 공식 수요로 쓰지 말 것.

## 🛰️ 사후 검증 (2026-09-01) — 위성 데스크

> 본문 전력 골격은 유지. 착공·가동은 전력 데스크 범위 밖이라 여기만 짧게 붙인다. 캠퍼스 표는 `AI데이터센터_위성검증_캠퍼스별_20260901.md`. 날짜 복제 파일은 더 만들지 않음.

- **Abilene 2GW 증설 취소.** Stargate 플래그십의 추가 2GW는 접혔고 잔여는 Microsoft 인접 부지. 지금 컴퓨트를 내는 Stargate 사이트는 Abilene 부분 가동뿐이다. 2편의 Crusoe Abilene 약 600MW 증설 취소와 같은 사건축(규모 표기는 출처가 다름).
- **Hyperion 5GW는 Holly Ridge에서 미입증.** 흙·1·2동 지붕은 2026-04 위성에 있다. Epoch 1단계 1,676MW IT, 목표 2028-01. 변전·가스가 먼저 올라와도 컴퓨트 온라인이 아니다.
- **Lordstown은 GW 캠퍼스가 아니다.** Foxconn 서버 제조 + 소형 DC(Epoch 예상 214MW IT).
- **광학 ≠ 통전.** 지붕·냉각이 보여도 GPU 가동이 아니다. Abilene은 위성 0.6GW 추정 뒤 Oracle 발언으로 0.3GW로 하향한 적이 있다.
