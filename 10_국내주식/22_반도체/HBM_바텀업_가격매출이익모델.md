...
## 🟢 2026-09-01 갱신 — 수요 캘린더·TAM (3사 IR 1차). 스택 단가는 안 바꿈

> 이 파일의 2026–27 **$/스택·산업 $ TAM 모델은 그대로 둔다.** 아래는 그 모델이 **회사 공시와 어긋나는 지점**만 표시. 웹(TrendForce·한국지 익명)은 2차.

### 회사가 찍은 숫자 (1차)

| 항목 | 값 | 출처 | 이 파일 모델과의 관계 |
|---|---|---|---|
| 마이크론 HBM TAM | 2025 ~$35B → **2028 ~$100B**, CAGR ~40%. 기존 2030 $100B를 **2년 앞당김** | FQ1 FY26 prepared remarks **2025-12-17** | 여기 2027 기본 **$150B**는 마이크론 공시보다 **낙관**. 9/30 FQ4에서 $100B/2028을 지키는지가 테스트 |
| 마이크론 HBM4E 볼륨 | **캘 2027** | FQ3 FY26 PR 2026-06-24 | 3사 중 **연도를 찍은 유일한 곳** |
| 삼성 HBM 매출 | **2026이 2025 대비 3배 이상**(회사 기대) | 2026-02-12 뉴스룸 | 물량·ASP 분해는 비공시 |
| SK하닉 HBM4 | 2Q 양산출하, **2H 램프**. HBM4E 1H 샘플. LTA ~10곳. “수요>공급능력” | 2Q26 PR 2026-07-29 | 타이트 언어는 이 파일과 정합 |
| 솔드아웃 연도 | 마이크론 공식 문장은 **CY2026**. “2028까지 솔드아웃” **8-K 없음** | 각사 PR | 곽 CEO “2030까지”는 기자회견 **2차** |

### 48 GB = 16층이 아님

다음 비트/스택 스텝은 16-hi 양산이 아니라 **HBM4E 12-hi 48 GB 퀄**. 삼성 5/29 PR이 그 샘플. SK하닉 6/18도 12-hi 48 GB 샘플, 양산은 “timely”(연도 없음).

### 2027 증설 ≠ 2027 비트

- 용인 1기: **클린룸 early 2027** (웨이퍼 비트는 장비·수율 래그 → **2028+**가 정직).
- P&T7: WT 2027-10, **WLP 2028-02**.
...
- **2026-09-01c TAM PDF:** 열 수 있는 IR 스니펫([static-files/823daff3](https://investors.micron.com/static-files/823daff3-66d2-4db0-aa63-43ba39ef728b))은 2028 TAM = 2024 **$16B의 4배**, **$100B 돌파는 2030**. FQ1 “2028 약 $100B” prepared-remarks PDF는 이 세션 CF 403. **확정 1차는 2030 경로.** 파일 **$150B/2027 모델은 그대로.**
