...
절반은 맞고 절반은 틀리다. 이건 앞서 쓴 [메모리 수요 구조 분석](../22_반도체/메모리수요_구조적인가_사이클인가_PERvsPBR_2026-07.md)과 **똑같은 프레임**으로 봐야 한다.
...
| 구분 | 강자 | 지정학 | 이수와의 관계 |
|---|---|---|---|
| **18층+ 고다층 MLB(매출)** | TTM(미국, 약 30% 1위), **이수(2위권, 10–15%)** | — | 이수가 글로벌 2–3위 |
