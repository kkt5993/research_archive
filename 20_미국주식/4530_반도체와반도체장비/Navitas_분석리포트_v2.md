...
| 분기말 현금 | 약 $75M (Q3 2025 기준 추정) → 추정치 오류 | **$221.0M** (3/31 기준) — 실제로는 v1 추정의–3배 |
...
| 증자 가능성 | "1–1.5년 내 증자 희석 현실적" | **2026-05-12 ATM $122M 완납 실현** (희석 약 3.5%, 현금 +56%) |
...
> v1에서 지적한 **"테마 ↔ 실적 괴리"** 가 **부분적으로** 좁혀졌다. Q1 실적은 가이던스 상단 적중, 디자인윈 백로그 5배 점프, ATM으로 증자 리스크 일소(一掃) 3박자가 갖춰지며 "쇼-미(show-me) 스토리"에서 **"실행 초기 검증"** 단계로 진입. 다만 **여전히** 2026 연간 매출 약 $41M 가이던스 대비 시총 $4B+(현재가 기준)의 EV/Sales 40–50x는 옵션 가격 영역. 2027 NVIDIA Kyber 양산까지 **18–20개월의 인내 구간**.
...
|---|---|---|---|
| 주가 | $15.66 (4/21) | **약 $21.17** (5/13) | +35% |
| 시가총액 | 약 $2.9B (188M주 기준) | **약 $4.1B** (약 195M주 기준, ATM 후) | +41% |
| 발행주식 수 | 약 188M | **약 194.5M** (188M + ATM 6.53M) | +3.5% 희석 |
| 분기말 현금 | 약 $75M 추정 → 오기 | **$221.0M** (3/31) → ATM 후 **약 $343M** | +358% |
...
다만 **EV/Sales 40–50x**는 여전. 2026 매출 가이던스 $41M 기준 시총 $4.1B → **P/S 약 100x**, 2027 매출 컨센서스 $150M 기준 **Forward P/S 27x**. 동종 GaN/SiC 평균 P/S 3–5x 대비 **5–10배 프리미엄**은 그대로.
...
- **현금 $221.0M** (FYE 2025 $236.9M 대비 -$15.9M, 분기 Cash Burn 약 $16M)
...
- 평균 PT 단일 분기에 약 70% 상향, 시장가 $21 vs 평균 PT $18 → 프리미엄 **+15% 수준**으로 축소 (v1 시점 +90% 프리미엄에서 정상화)

### 2026-05-11 (월) — 주가 +25% 랠리
- Q1 실적·디자인윈·애널리스트 PT 상향 효과 누적
- 종가 추정 약 $21–22 구간, **YTD +400%+ 종목 재확인**
...
| Non-GAAP GM | 약 38% | 38.5% | **39.0%** | **소폭 Beat** |
...
|---|---|---|
| 2025 Q3 (10월 컨콜) | 약 $300M | 모바일 + 일부 데이터센터 초기 |
...
- 추정: 2026–2030 (5년) 누적
- 이 경우 **연 환산 약 $480M** — 2030 SAM $3.5B의 13.7% 점유 가정과 정합
...
- Kyber 랙은 **576 Rubin Ultra GPU** 수용, 랙당 약 1MW 전력 → Navitas 콘텐츠 추정 랙당 $30K–$100K
...
| **5/12 ATM 완납 후 (추정)** | **약 $343M** | +$122M |
| Q2E말 (6/30, OpEx 차감 추정) | 약 $330M | -$13M (Q2 Cash Burn) |
...
| **2026-05-06 (v2 시점)** | **약 $17.0 (재산정)** | 3사 일제 상향 |
...
|---|---|---|---|---|---|---|---|
| **Navitas (NVTS)** | **$4.12B** | **$3.78B** (현금 $343M 차감) | **n/a (적자)** | **약 92x** ($41M) | **약 25x** ($150M 가정) | 약 5x | **5년 밴드 최상단** |
| Power Integrations (POWI) | 약 $4.4B |–$4.0B | 35-40x |–9x |–8x |–5x | 5년 평균 부근 |
| Wolfspeed (WOLF) | 약 $0.8B |–$2.5B (부채 多) | n/a | 약 3x |–2.5x |–1x | 5년 밴드 하단 |
| onsemi (ON) | 약 $25B |–$24B | 18-22x |–3.5x |–3x |–2.5x | 5년 평균 부근 |
| Infineon (IFX) | 약 €55B |–€52B | 22-25x |–3x |–2.7x |–2x | 5년 평균 부근 |
| TI (Texas Instruments) | 약 $160B |–$155B | 25-28x |–7x |–6.5x |–10x | 평균 부근 |
...
| **2026-05-13 (v2)** | **$4.1B** | **약 92x (2026E $41M)** / **25x (2027E $150M)** |
...
|---|---|---|---|---|
| **🟢 Bull** | ① NVIDIA Kyber 2027 양산 시작 + Microsoft·Google 추가 디자인윈, ② $2.4B 백로그 50%+ 전환율 양산화, ③ Non-GAAP BEP 2027 Q3 도달, ④ TI 추격 지연 | **$250M** | **25x** = **$6.25B 시총** | **주당 약 $32** (+51% 상방) |
| **🟡 Base** | ① Q2~Q4 가이던스 적중, ② $2.4B 백로그 40% 전환, ③ NVIDIA 매출 2027 $100M 적중, ④ 추가 ATM 없음 | $150M | 20x = $3.0B 시총 | **주당 약 $15** (-29% 하방) |
| **🔴 Bear** | ① NVIDIA Kyber 양산 6개월–1년 지연, ② TI/Infineon 가격 공세, ③ 백로그 전환율 25%로 하향, ④ 2027 Q1 추가 ATM $100M | $90M | 10x = $0.9B 시총 | **주당 약 $4.5** (-79% 하방) |
...
| **5/11 (월)** | $20.2 | $22.5 | $20.0 | **약 $21.5** (+25% 주간) | **IBTimes·Motley Fool 헤드라인** |
